  ...
  while t < args.num_iterations:
    ...
    for batch in train_loader:
      ...
      for turn in range(feats_var.size(0)):
        ...
        #print("Logits_currentturn size 0 " + str(Logits_currentturn.size(0)))
        #print("Logits_currentturn size 1 " + str(Logits_currentturn.size(1)))
        ...
        #print("vt size 0 " + str(vt.size(0)))
        #print("vt size 1 " + str(vt.size(1)))

        loss_current_s2a = torch.mean(Logits_currentturn*vt)
        loss_current_s2a.requires_grad=True
        #print("shape " + str(loss_current_s2a))
        #loss_current_s2a = torch.mean(vt*vt)
